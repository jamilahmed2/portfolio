...
onMounted(() => {
    typed = new Typed(typedElement.value, {
        strings: ["Crafting Digital Experiences", "Full Stack Developer"],
        typeSpeed: 50,
        backSpeed: 30,
        backDelay: 5000,
        loop: true,
...
<template>
    ...
    <section id="home" class="relative min-h-[calc(100vh-85px)] overflow-x-clip bg-slate-100 dark:bg-[#0B1120]">
        ...
        <div class="absolute bottom-44 -left-64 h-[150px] w-[900px] -rotate-45 rounded-3xl bg-gradient-to-r from-violet-600 to-indigo-800 opacity-30 dark:opacity-30 blur-3xl filter block lg:bottom-24 lg:-left-20 lg:h-28 lg:w-[250px] lg:-rotate-12 dark:lg:opacity-20 lg:opacity-30 xl:h-40 xl:w-[400px]"></div>
        <div class="absolute left-[28%] top-28 hidden rotate-12 rounded-3xl bg-sky-800 blur-3xl filter opacity-20 dark:opacity-30 lg:h-32 lg:w-[450px] lg:block xl:h-44 xl:w-[600px]"></div>
        ...
        <div class="container mx-auto px-3 flex flex-col justify-center items-center min-h-[calc(100vh-85px)] max-w-6xl 2xl:max-w-7xl">
            ...
            >
                I'm <span class="bg-clip-text text-transparent bg-gradient-to-r from-sky-500 to-purple-500 dark:from-sky-400 dark:to-teal-400">Jamil Ahmed</span>
            </h1>
            <h2
                v-motion
                :initial="{
            ...
            >
                <a href="https://github.com/jamilahmed2" target="_blank" class="group flex items-center space-x-3">
                    <img class="w-[1.5rem] md:w-[1.7rem]" src="/images/github.png" alt="Jamil's Github" />
                ...
                <a href="https://www.linkedin.com/in/jamil-ahmed-54655220b/" target="_blank" class="group flex items-center space-x-3">
                    <img class="w-[1.5rem] md:w-[1.7rem]" src="/images/linkedin.png" alt="Jamil's Linkedin" />
            ...
            >
                <LinkButton link="#about" class="text-sm md:text-xl px-5 py-3 md:px-7 md:py-4"> Discover My Story </LinkButton>
